...
public:
  ...
  /**
   * DEPRECATED
   * @return a list of the currently registered NetworkConfigFactories.
   */
   ...
   * will call through the server into the config to get the cluster manager so the server variable
   * must be initialized.
   * @param fixfix
   * @param fixfix
   */
